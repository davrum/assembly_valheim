...
{
	public const uint m_networkVersion = 35u;

	public const int m_playerVersion = 42;

	public const int m_oldestForwardCompatiblePlayerVersion = 27;

	public const int m_worldVersion = 36;
	...
	public static GameVersion CurrentVersion { get; } = new GameVersion(0, 221, 4);
	...
	public static Platforms GetPlatform()
	{
		...
		{
			return Platforms.SteamDeckNative;
		}
		return Platforms.SteamLinux;
	}
