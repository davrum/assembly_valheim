...
public static class CensorShittyWords
{
	...
	public static readonly List<string> m_exemptWords = new List<string>
	{
		...
		"assumption", "assumable", "assumably", "assumptive", "assure", "assurance", "assurant", "baller", "bass", "bitcraft",
		"blade", "brass", "bunga", "bypass", "canal", "canvassed", "carcass", "cassette", "circumference", "circumstance",
		"circumstancial", "chassi", "chassis", "class", "classic", "compass", "compassion", "crass", "crevass", "cum laude",
		"donalds", "drunken", "embarrass", "embassade", "embassador", "embassy", "encompass", "enigma", "extravaganza", "eyeballs",
		"eyeballz", "gassy", "gasses", "glass", "grape", "grass", "harass", "honig", "horsemen", "jazz",
		"jurassic", "kanal", "kass", "knight", "krass", "krasse", "kvass", "lass", "lasso", "mass",
		"massive", "morass", "night", "palazzo", "pass", "passenger", "passion", "passive", "password", "petits",
		"potassium", "quintenassien", "raccoon", "racoon", "rassel", "rasselbande", "reiniger", "tassel", "tassen", "teldrassil",
		"transpenisular", "trespass", "sass", "sassy", "sassier", "sassiest", "sassily", "sauvage", "sauvages", "shenanigans",
		"skibladner", "something", "strasse", "surpass", "wassap", "wasser"
	};
	...
	public static readonly List<string> m_exemptPlaces = new List<string> { "bumpass", "clitheroe", "dassel", "penistone", "toppenish", "twatt", "scunthorpe", "sussex", "vaggeryd", "nassau" };
