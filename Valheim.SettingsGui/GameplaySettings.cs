...
public class GameplaySettings : SettingsBase
{
	...
	{
		SetNavigation(m_deleteAccount, NavigationDirection.OnDown, backButton);
		SetNavigation(backButton, NavigationDirection.OnUp, m_deleteAccount);
	}

	public override void FixOkButtonNavigation(Button okButton)
	{
		SetNavigation(okButton, NavigationDirection.OnUp, m_deleteAccount);
	}
